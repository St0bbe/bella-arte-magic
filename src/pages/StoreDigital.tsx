...
import { 
  Search, Download, SlidersHorizontal, X, ArrowUpDown,
...
export default function StoreDigital() {
  ...
  const { data: products, isLoading } = useProducts("digital");
  ...
  return (
    <>
      <Helmet>
        <title>Produtos Digitais Personalizados | Loja Bella Arte</title>
        <meta
          name="description"
          content="Convites digitais, kits de festa e artes personalizadas para sua celebração. Prazo de produção de 3 dias úteis. Entrega em PDF de alta qualidade."
        />
      </Helmet>
      ...
      <main className="min-h-screen bg-white">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-blue-50 via-white to-store-cream/30 py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-blue-700 mb-4">
                <Download className="w-4 h-4" />
                <span className="text-sm font-medium">Produtos Digitais</span>
              </div>
              ...
              <p className="text-store-text/70 mb-6">
                Convites, kits de festa e lembrancinhas digitais criadas especialmente 
                para tornar sua celebração única e inesquecível.
              </p>
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                <div className="flex items-center gap-3 bg-white rounded-xl p-4 border border-blue-100 shadow-sm">
                  ...
                  <div>
                    <p className="font-semibold text-store-text text-sm">3 Dias Úteis</p>
                    <p className="text-xs text-store-text/60">Prazo de produção</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-white rounded-xl p-4 border border-blue-100 shadow-sm">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-semibold text-store-text text-sm">PDF de Alta Qualidade</p>
                    <p className="text-xs text-store-text/60">Pronto para impressão</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-white rounded-xl p-4 border border-blue-100 shadow-sm">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-semibold text-store-text text-sm">100% Personalizado</p>
                    <p className="text-xs text-store-text/60">Feito para você</p>
                  </div>
                </div>
              </div>
            </div>
...
function FilterContent({
  ...
  return (
    <>
      <div>
        <h3 className="font-semibold text-store-text mb-3">Tipo de Produto</h3>
